export default function NotificationSuccess({ headerText, description }: { headerText: string, description: string }) {
    return (
        <div className="bg-white inline-flex space-x-3 p-3 text-sm rounded border border-gray-200">
            ...
            <div>
                <h3 className="text-slate-700 font-medium">{headerText}</h3>
