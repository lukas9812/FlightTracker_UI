...
export default function RegisterPage() {
    return (
        <div className="flex flex-row items-start justify-center pt-20 gap-20 w-full">

            <div className="relative flex flex-col items-start rounded-xl bg-transparent max-w-md">
            ...
            <form className="mt-8 p-8 mb-2 rounded-lg bg-slate-700 w-80 sm:w-96">
            ...
            <div className="max-w-xs pt-40">
                <h2 className="text-white text-4xl font-semibold mb-6">Why join us?</h2>
                <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                        <div className="mt-1 h-5 w-5 flex-none rounded-full bg-blue-600/20 flex items-center justify-center">
                    ...
                    <li className="flex items-start gap-3">
                        <div className="mt-1 h-5 w-5 flex-none rounded-full bg-purple-600/20 flex items-center justify-center">
                    ...
                    <li className="flex items-start gap-3">
                        <div className="mt-1 h-5 w-5 flex-none rounded-full bg-red-600/20 flex items-center justify-center">
                    ...
                    <li className="flex items-start gap-3">
                        <div className="mt-1 h-5 w-5 flex-none rounded-full bg-green-600/20 flex items-center justify-center">
